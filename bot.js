...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=551760518050742285&scope=bot&permissions=2146958588585D')
  .setDescription(`**
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discordapp.com/oauth2/authorize?client_id=551760518050742285&scope=bot&permissions=2146958588585D**")
